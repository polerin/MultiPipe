...
public partial class PauseMenu : Node2D
{
    ...
    {
        //hackety hack hack 
        this.ButtonQuitToMenu = this.GetNode<Button>("MenuContainer/PauseMenu/ButtonQuitToMenu");
        this.ButtonQuitToMenu.Pressed += () => this.LoadGameScene("main_menu");

        this.ButtonQuitToDesktop = this.GetNode<Button>("MenuContainer/PauseMenu/ButtonQuitToDesktop");
